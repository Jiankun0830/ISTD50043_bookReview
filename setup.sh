...
curl https://raw.githubusercontent.com/Jiankun0830/ISTD50043_bookReview/master/script/analytics_backend_setup.sh --output analytics_backend_setup.sh



read -p "Create new python virtual environment goodshelf to run command y or n?" create
